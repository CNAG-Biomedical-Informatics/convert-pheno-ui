...
cd "/home/ivo/projects/bioinfo/cnag/repos/keycloak_react_themes/build_keycloak"
...
docker run \
   ...
   -v "$(pwd)/target/keycloakify-starter-keycloak-theme-5.0.3.jar":"/opt/keycloak/providers/keycloakify-starter-keycloak-theme-5.0.3.jar" \
